...
async function go() {
  let client = new MongoClient('mongodb+srv://todoAppUser:Penis1@cluster0.d78zqbz.mongodb.net/TodoApp?retryWrites=true&w=majority')
  client.connect()
  db = client.db()
  app.listen(3000)
}
...
function passwordProtected(req, res, next) {
  ...
  if (req.headers.authorization == "Basic TGVhcm46YWJjZA==") {
    next()
  } else {
